...
; 0000 0032 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	OUT  0x15,R30
; 0000 0033 
...
; 0000 0083 while (1){
_0x3:
; 0000 0084         PORTA++; //incrementa valor de puerto
	IN   R30,0x1B
	SUBI R30,-LOW(1)
	OUT  0x1B,R30
; 0000 0085         PORTC--; //decrementa valor del puerto
	IN   R30,0x15
	SUBI R30,LOW(1)
	OUT  0x15,R30
; 0000 0086         delay_ms(250); //retardo que se genera para visualizar la información
	LDI  R26,LOW(250)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0087     }
