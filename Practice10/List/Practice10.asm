...
; 0000 002F DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0030 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
...
; 0000 0082 while (1){
_0x4:
; 0000 0083         //C0 A C2 son de salida y son para
; 0000 0084         //Probar las 3 columnas
; 0000 0085         //Se prueba la primera columna se envía 110
; 0000 0086         PORTC=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 0087         //C3, C4 y C5 son las entradas del teclado
; 0000 0088         //Por eso se enmascaran con 00111000
; 0000 0089         lectura=PINC&0b00111000;
; 0000 008A         if (lectura==0b00110000)
	BRNE _0x7
; 0000 008B             tecla=7;
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 008C         if (lectura==0b00101000)
_0x7:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x8
; 0000 008D             tecla=8;
	LDI  R30,LOW(8)
	MOV  R5,R30
; 0000 008E         if (lectura==0b00011000)
_0x8:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x9
; 0000 008F             tecla=9;
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0090         //se prueba segunda columna se envía 101
; 0000 0091         PORTC=0b00111101;
_0x9:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 0092         //C3, C4 y C5 son las entradas del teclado
; 0000 0093         //Por eso se enmascaran con 00111000
; 0000 0094         lectura=PINC&0b00111000;
; 0000 0095         if (lectura==0b00110000)
	BRNE _0xA
; 0000 0096             tecla=4;
	LDI  R30,LOW(4)
	MOV  R5,R30
...
; 0000 0098             tecla=5;
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 0099         if (lectura==0b00011000)
_0xB:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xC
; 0000 009A             tecla=6;
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 009B         //se prueba tercera columna se envía 011
; 0000 009C         PORTC=0b00111011;
_0xC:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 009D         //C3, C4 y C5 son las entradas del teclado
; 0000 009E         //Por eso se enmascaran con 00111000
; 0000 009F         lectura=PINC&0b00111000;
; 0000 00A0         if (lectura==0b00110000)
	BRNE _0xD
; 0000 00A1             tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00A2         if (lectura==0b00101000)
_0xD:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xE
; 0000 00A3             tecla=2;
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 00A4         if (lectura==0b00011000)
_0xE:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xF
; 0000 00A5             tecla=3;
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 00A6         PORTB=tabla7segmentos [tecla];
_0xF:
	MOV  R30,R5
	LDI  R31,0
