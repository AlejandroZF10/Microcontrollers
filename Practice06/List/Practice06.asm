...
; 0000 003B DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 003C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 003D PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 003E 
...
_0x11:
	BLD  R2,1
; 0000 008E         if ((botonp==1)&&(botona==0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xA
	LDI  R26,0
	SBRC R2,1
...
_0xB:
; 0000 008F         {
; 0000 0090             var++; //Se incrementa la variable
	INC  R5
; 0000 0091             if (var==10)
	LDI  R30,LOW(10)
	CP   R30,R5
...
; 0000 0092                 var=0;
	CLR  R5
; 0000 0093             delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
_0xC:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0094         }
; 0000 0095         if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0x9:
	LDI  R26,0
	SBRC R2,0
	LDI  R26,1
...
; 0000 0096             delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 0097         PORTB=tabla7segmentos [var];
_0xD:
	MOV  R30,R5
	LDI  R31,0
