...
_0x3:
	.DB  0x41,0x36,0x3A,0x3C,0x41,0x7F,0x7B,0x0
	.DB  0x7F,0x7F,0x6,0x36,0x36,0x36,0x30,0x36
	.DB  0x36,0x36,0x36,0x0,0x70,0x77,0x77,0x77
	.DB  0x0,0x30,0x36,0x36,0x36,0x6,0x0,0x36
	.DB  0x36,0x36,0x6,0x7E,0x7E,0x76,0x76,0x0
	.DB  0x41,0x36,0x36,0x36,0x41,0x30,0x36,0x36
	.DB  0x36
_0x4:
...
;const char numeros[10][5]={{0x41,0x36,0x3a,0x3c,0x41},{0x7f,0x7b,0x00,0x7f,0x7f},{0x06,0x36,0x36,0x36,0x30},{0x36,0x36,0x36,0x36,0x00},{0x70,0x77,0x77,0x77,0x00},{0x30,0x36,0x36,0x36,0x06},{0x00,0x36,0x36,0x36,0x06},{0x7e,0x7e,0x76,0x76,0x00},{0x41,0x36,0x36,0x36,0x41},{0x30,0x36,0x36,0x36,0x00}};

	.DSEG
;const char col[5]={0x01,0x02,0x04,0x08,0x10};
;int i,j,k;
;void main(void)
; 0000 0020 {
...
; 0000 008D                     PORTC=~col[k];
	...
	COM  R30
	OUT  0x15,R30
; 0000 008E                     PORTD=~numeros[i][k];
	MOVW R30,R4
	LDI  R26,LOW(5)
	LDI  R27,HIGH(5)
	RCALL __MULW12U
	SUBI R30,LOW(-_numeros)
	SBCI R31,HIGH(-_numeros)
	ADD  R30,R8
	ADC  R31,R9
	LD   R30,Z
	COM  R30
