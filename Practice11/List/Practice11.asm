...
; 0000 0036 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0037 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=P Bit0=P
; 0000 0038 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 0039 
...
; 0000 0087 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0088 
; 0000 0089 if (datoaguardar>10)
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	CPI  R30,LOW(0xB)
	BRLO _0x4
; 0000 008A datoaguardar=0;
	RCALL SUBOPT_0x0
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 008B var=datoaguardar;
_0x4:
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	MOV  R5,R30
...
; 0000 008F         PORTB=tabla7segmentos [var];
	...
	LD   R30,Z
	OUT  0x18,R30
; 0000 0090         if (boton_guarda==0) //Si se presiona el botón de guardar
	SBIC 0x13,1
	RJMP _0x8
; 0000 0091         datoaguardar=var; //se grabara la eeprom con el valor de var
	MOV  R30,R5
	RCALL SUBOPT_0x0
	RCALL __EEPROMWRB
...
; 0000 0095 void checa_boton (void){
_checa_boton:
; .FSTART _checa_boton
; 0000 0096     if (boton==0)
	SBIC 0x13,0
	RJMP _0xA
; 0000 0097         botona=0;
	CLT
...
_0x13:
	BLD  R2,1
; 0000 009A     if ((botonp==1)&&(botona==0)){ //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xD
	LDI  R26,0
	SBRC R2,1
...
_0xD:
	RJMP _0xC
_0xE:
; 0000 009B         var++; //Se incrementa la variable
	INC  R5
; 0000 009C         if (var>=10)
	LDI  R30,LOW(10)
	CP   R5,R30
...
; 0000 009D             var=0;
	CLR  R5
; 0000 009E         delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
_0xF:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 009F     }
; 0000 00A0     if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0xC:
	LDI  R26,0
	SBRC R2,0
	LDI  R26,1
...
_0x11:
	RJMP _0x10
_0x12:
; 0000 00A1         delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A2     botonp=botona;
_0x10:
	BST  R2,1
	BLD  R2,0
; 0000 00A3 }
