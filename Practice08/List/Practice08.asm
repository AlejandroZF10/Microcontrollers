...
; 0000 002A DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 002B // State: Bit7=0 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 002C PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(127)
	OUT  0x1B,R30
; 0000 002D 
...
; 0000 003C DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 003D // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 003E PORTD=(0<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(127)
	OUT  0x12,R30
; 0000 003F 
...
; 0000 008D             var2=0;
; 0000 008E             i=0;
; 0000 008F             PORTC=tabla7segmentos[var];
; 0000 0090             PORTA=tabla7segmentos[var1];
; 0000 0091             PORTB=tabla7segmentos[var2];
; 0000 0092         }
; 0000 0093 
; 0000 0094         if(start==0){
	SBIC 0x10,2
	RJMP _0x8
; 0000 0095             for(i=0; i<=600; i++){
	CLR  R4
	CLR  R5
_0xA:
	LDI  R30,LOW(600)
...
; 0000 00A9                     l=var2;
	...
	ST   Y,R30
	STD  Y+1,R31
; 0000 00AA                     PORTC=tabla7segmentos[j];
	LDD  R30,Y+4
	LDD  R31,Y+4+1
	RCALL SUBOPT_0x1
	OUT  0x15,R30
; 0000 00AB                     PORTA=tabla7segmentos[k];
	LDD  R30,Y+2
	LDD  R31,Y+2+1
	RCALL SUBOPT_0x1
	OUT  0x1B,R30
; 0000 00AC                     PORTB=tabla7segmentos[l];
	LD   R30,Y
	LDD  R31,Y+1
	RCALL SUBOPT_0x1
	OUT  0x18,R30
...
; 0000 00B2                     var2=0;
; 0000 00B3                     i=0;
; 0000 00B4                     PORTC=tabla7segmentos[var];
; 0000 00B5                     PORTA=tabla7segmentos[var1];
; 0000 00B6                     PORTB=tabla7segmentos[var2];
; 0000 00B7                     break;
	RJMP _0xB
; 0000 00B8                 }
...
_0x10:
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 00BA                 PORTC=tabla7segmentos[var];
	MOV  R30,R7
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x15,R30
; 0000 00BB                 PORTA=tabla7segmentos[var1];
	MOV  R30,R6
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x1B,R30
; 0000 00BC                 PORTB=tabla7segmentos[var2];
	MOV  R30,R9
	LDI  R31,0
	RCALL SUBOPT_0x1
	OUT  0x18,R30
...
_0xB:
; 0000 00BE       }
; 0000 00BF       //continuacion por si la riego
; 0000 00C0     }
_0x8:
	RJMP _0x4
; 0000 00C1 }
