...
;
;int var1,var2;
;const char tabla[9]={0x00,0x01,0x03,0x07,0x0f,0x1f,0x3f,0x7f,0xff};
...
; 0000 008B // ADC Clock frequency: 500,000 kHz
; 0000 008C // ADC Voltage Reference: AVCC pin
...
; 0000 0091 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 0092 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
; 0000 0093 SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 0094 
...
_0x7:
; 0000 009E       {
; 0000 009F       var1=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOV  R4,R30
	CLR  R5
; 0000 00A0       var2=read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOV  R6,R30
	CLR  R7
; 0000 00A1 
; 0000 00A2       PORTB=tabla[var1/32];
	MOVW R26,R4
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 00A3       delay_ms(5);
	LDI  R26,LOW(5)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A4       PORTC=tabla[var2/32];
	MOVW R26,R6
	RCALL SUBOPT_0x0
	OUT  0x15,R30
