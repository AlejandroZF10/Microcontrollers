...
; 0000 0037 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0038 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 0039 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 003A 
...
_0x4:
; 0000 0085       {
; 0000 0086         if (boton==0)
	SBIS 0x10,0
; 0000 0087             var1++;
	INC  R5
; 0000 0088         if (var1==10)
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x8
; 0000 0089             var1=0;
	CLR  R5
; 0000 008A         PORTB=tabla7segmentos [var1];
_0x8:
	MOV  R30,R5
	LDI  R31,0
