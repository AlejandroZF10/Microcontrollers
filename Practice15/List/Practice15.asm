...
; 0000 0046 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
_0x7:
; 0000 00A6       {
; 0000 00A7       cn=(read_adc(0)*50)/255;
	LDI  R26,LOW(0)
	RCALL _read_adc
	LDI  R26,LOW(50)
	MUL  R30,R26
...
; 0000 00A9       unidades=cn%10;
	...
	MOV  R7,R30
; 0000 00AA 
; 0000 00AB       PORTB=tab7seg[decenas];
	MOV  R30,R4
	RCALL SUBOPT_0x0
; 0000 00AC       C0=0;
	CBI  0x15,0
...
; 0000 00AF 
; 0000 00B0 
; 0000 00B1       PORTB=tab7seg[unidades];
	MOV  R30,R7
	RCALL SUBOPT_0x0
; 0000 00B2       C0=1;
	SBI  0x15,0
