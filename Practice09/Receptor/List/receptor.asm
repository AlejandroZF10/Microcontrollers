...
; 0000 001C     {
; 0000 001D 
; 0000 001E         delay_ms(6);
	LDI  R26,LOW(6)
	RCALL SUBOPT_0x0
; 0000 001F         if(PINB & 0x1)
	SBIS 0x16,0
	RJMP _0x6
; 0000 0020             delay_ms(4);
	LDI  R26,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0021         else
	RJMP _0x7
_0x6:
; 0000 0022             return 0x2;     //izquierda
	LDI  R30,LOW(2)
	RET
; 0000 0023 
; 0000 0024         if(PINB & 0x1)
_0x7:
	SBIS 0x16,0
	RJMP _0x8
...
; 0000 0026         else
	RJMP _0x9
_0x8:
; 0000 0027             return 0x1;    //derecha
	LDI  R30,LOW(1)
	RET
; 0000 0028 
; 0000 0029         if(PINB & 0x1)
_0x9:
	SBIS 0x16,0
	RJMP _0xA
...
; 0000 002B         else
	RJMP _0xB
_0xA:
; 0000 002C             return 0x3;         //arribe
	LDI  R30,LOW(3)
	RET
; 0000 002D 
; 0000 002E         if(PINB & 0x1)
_0xB:
	SBIC 0x16,0
; 0000 002F             return 0;
	RJMP _0x2000001
; 0000 0030         else
; 0000 0031             return 0xc;         //abajo
	LDI  R30,LOW(12)
	RET
; 0000 0032     }
; 0000 0033     return 0;
...
_0xE:
; 0000 00A1       {
; 0000 00A2         anterior = PINB & 1;
	IN   R30,0x16
	ANDI R30,LOW(0x1)
	MOV  R5,R30
; 0000 00A3         PORTD = getPIN();
	RCALL _getPIN
	OUT  0x12,R30
; 0000 00A4         if(PORTD != 0)
	IN   R30,0x12
	CPI  R30,0
	BREQ _0x11
