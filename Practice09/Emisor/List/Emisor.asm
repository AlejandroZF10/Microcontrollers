...
; 0000 0026 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0027 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0028 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0029 
...
; 0000 0032 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 005B ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 005C TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
_0x3:
; 0000 0087       {
; 0000 0088           opcion = PINB & 0x0f;
	IN   R30,0x16
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0089 
; 0000 008A           if(opcion == 0x0e)//Arriba
	LDI  R30,LOW(14)
	CP   R30,R5
	BRNE _0x6
; 0000 008B           {
; 0000 008C             for(var = 0; var < 20; var++)
	CLR  R4
_0x8:
	LDI  R30,LOW(20)
	CP   R4,R30
...
_0x9:
; 0000 0093           }
; 0000 0094           else if(opcion == 0x0d)//Abajo
	RJMP _0xA
_0x6:
	LDI  R30,LOW(13)
	CP   R30,R5
	BRNE _0xB
; 0000 0095           {
; 0000 0096             for(var = 0; var < 30 ; var++)
	CLR  R4
_0xD:
	LDI  R30,LOW(30)
	CP   R4,R30
...
_0xE:
; 0000 009D           }
; 0000 009E           else if(opcion == 0x0b)//Izquierda
	RJMP _0xF
_0xB:
	LDI  R30,LOW(11)
	CP   R30,R5
	BRNE _0x10
; 0000 009F           {
; 0000 00A0             for(var = 0; var < 40; var++)
	CLR  R4
_0x12:
	LDI  R30,LOW(40)
	CP   R4,R30
...
_0x13:
; 0000 00A7           }
; 0000 00A8           else if(opcion == 0x07)//Derecha
	RJMP _0x14
_0x10:
	LDI  R30,LOW(7)
	CP   R30,R5
	BRNE _0x15
; 0000 00A9           {
; 0000 00AA             for(var = 0; var < 50; var++)
	CLR  R4
_0x17:
	LDI  R30,LOW(50)
	CP   R4,R30
