...
_0xE:
	BLD  R2,1
; 0000 008D         if ((botona==0)&&(botonp==1)) //hubo cambio de flanco de 1 a 0
	LDI  R26,0
	SBRC R2,1
	LDI  R26,1
	CPI  R26,LOW(0x0)
...
_0xA:
	RJMP _0x9
_0xB:
; 0000 008E             var++; //Se incrementa la variable
	INC  R5
; 0000 008F         if (var==10)
_0x9:
	LDI  R30,LOW(10)
...
; 0000 0090             var=0;
	CLR  R5
; 0000 0091         PORTB=tabla7segmentos [var];
_0xC:
	MOV  R30,R5
	LDI  R31,0
